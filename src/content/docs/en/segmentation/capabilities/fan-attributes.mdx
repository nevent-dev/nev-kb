...
*For a deeper look at combining criteria, see the [operators and logic guide](/en/segmentation/segmentation-engine/operators-and-logic/) in the Segmentation Engine section. For further reading on demographic segmentation in event marketing, you can consult the <a href="https://docs.mixpanel.com/docs/data-structure/user-profiles" target="_blank" rel="noopener noreferrer">Mixpanel documentation on user profiles and segmentation</a>.*
