...
1. **[Best Practices](/en/segmentation/segmentation-engine/best-practices/)** — Optimise your segments
2. **[FAQ](/en/segmentation/segmentation-engine/faq/)** — Answers to common questions
3. **[Back to Introduction](/en/segmentation/segmentation-engine/)** — Review the fundamentals

---

[9 best practices to maximise open rate, conversion and ROI →](/en/segmentation/segmentation-engine/best-practices/)
