...
1. **[Apply in Use Cases](/en/segmentation/segmentation-engine/use-cases/)** — See practical examples with modifiers
2. **[Operators & Logic](/en/segmentation/segmentation-engine/operators-and-logic/)** — Combine modifiers with AND/OR logic
3. **[Best Practices](/en/segmentation/segmentation-engine/best-practices/)** — Optimise your RFM segments

---

[6 use cases with real numbers: from early bird to VIP win-back →](/en/segmentation/segmentation-engine/use-cases/)
