...
1. **[See Full Use Cases](/en/segmentation/segmentation-engine/use-cases/)** — Real examples with groups
2. **[Best Practices](/en/segmentation/segmentation-engine/best-practices/)** — Optimise your A/B tests
3. **[FAQ](/en/segmentation/segmentation-engine/faq/)** — Answers to common questions

---

**Ready for scientific testing?** 🧪

[Examples of A/B testing: subject lines, prices, offers with groups →](/en/segmentation/segmentation-engine/use-cases/)
