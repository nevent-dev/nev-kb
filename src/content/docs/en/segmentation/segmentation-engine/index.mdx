...
1. **[Creating a Segment](/en/segmentation/segmentation-engine/creating-a-segment/)** — Learn the basic process
2. **[The 6 Categories](/en/segmentation/segmentation-engine/categories/)** — Discover the criteria you can use
3. **[Practical Use Cases](/en/segmentation/segmentation-engine/use-cases/)** — Get inspired by real examples
4. **[Best Practices](/en/segmentation/segmentation-engine/best-practices/)** — Avoid common mistakes
</Aside>
...
👉 [Step-by-step tutorial: create a VIP segment for early bird in 5 minutes](/en/segmentation/segmentation-engine/creating-a-segment/)
