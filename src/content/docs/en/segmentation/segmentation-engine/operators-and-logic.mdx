...
1. **[Learn about Groups](/en/segmentation/segmentation-engine/groups/)** — A/B testing and progressive sends
2. **[See Real Use Cases](/en/segmentation/segmentation-engine/use-cases/)** — Complete examples with advanced logic
3. **[Best Practices](/en/segmentation/segmentation-engine/best-practices/)** — Optimise your segments

---

[Apply operators in 6 real examples: VIPs, early bird, multi-city →](/en/segmentation/segmentation-engine/use-cases/)
