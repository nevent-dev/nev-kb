...
<Schema>{`{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://docs.nevent.com/en/segmentation/segmentation-engine/categories"
    }
  ]
}`}</Schema>
...
For mid-size festivals, we recommend classifying VIPs with spend ≥€500. This threshold varies based on average ticket; see our [best practices guide to calculate VIP thresholds by event type](/en/segmentation/segmentation-engine/best-practices/).
...
1. **[Learn to Use Operators](/en/segmentation/segmentation-engine/operators-and-logic/)** — How to compare and combine criteria
2. **[See Real Use Cases](/en/segmentation/segmentation-engine/use-cases/)** — Inspiration with complete examples
3. **[Best Practices](/en/segmentation/segmentation-engine/best-practices/)** — Tips to optimise results

---

[RFM analysis: automatically identify Champions and at-risk VIPs →](/en/segmentation/segmentation-engine/modifiers-and-rfm/)
