...
<Schema>{`{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "FAQ",
      "item": "https://docs.nevent.com/en/segmentation/segmentation-engine/faq"
    }
  ]
}`}</Schema>
...
- 📖 [Back to Introduction](/en/segmentation/segmentation-engine/)
- 📚 [See Use Cases](/en/segmentation/segmentation-engine/use-cases/)
- 💬 Contact support: support@nevent.ai
...
[Back to the Segmentation Engine: complete guide with 6 categories and RFM →](/en/segmentation/segmentation-engine/)
