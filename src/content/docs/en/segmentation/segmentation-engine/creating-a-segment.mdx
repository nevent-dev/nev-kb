...
[Explore the 8 criterion categories: events, spend, location, temperature →](/en/segmentation/segmentation-engine/categories/)
...
[Learn comparison operators: equals, greater than, contains, between dates →](/en/segmentation/segmentation-engine/operators-and-logic/)
...
You can combine multiple criteria using AND/OR operators. For example, "VIPs from Barcelona" requires [combining spend AND location with the AND operator](/en/segmentation/segmentation-engine/operators-and-logic/).
...
[Master AND/OR logic: combine multiple criteria with boolean operators →](/en/segmentation/segmentation-engine/operators-and-logic/)
...
**Solution**: Check the [full categories reference](/en/segmentation/segmentation-engine/categories/) or contact support.
...
1. **[Explore the 6 Categories](/en/segmentation/segmentation-engine/categories/)** — Discover all available criteria
2. **[Learn Advanced AND/OR Logic](/en/segmentation/segmentation-engine/operators-and-logic/)** — Create complex segments
3. **[See Real Use Cases](/en/segmentation/segmentation-engine/use-cases/)** — Get inspired by examples
4. **[Best Practices](/en/segmentation/segmentation-engine/best-practices/)** — Optimise your results

---

**Ready to create your first segment?** 🎯

[See 6 festival segmentation use cases: early bird, VIPs, reactivation →](/en/segmentation/segmentation-engine/use-cases/)
