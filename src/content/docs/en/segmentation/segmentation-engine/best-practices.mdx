...
<Schema>{`{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Best Practices",
      "item": "https://docs.nevent.com/en/segmentation/segmentation-engine/best-practices"
    }
  ]
}`}</Schema>
...
The optimal frequency depends on segment temperature. For specific questions, see our [FAQ section on frequency and deliverability](/en/segmentation/segmentation-engine/faq/#frequency).
...
1. **[FAQ](/en/segmentation/segmentation-engine/faq/)** — Answers to common questions
2. **[Use Cases](/en/segmentation/segmentation-engine/use-cases/)** — Practical application
3. **[Back to Introduction](/en/segmentation/segmentation-engine/)** — Full review

---

**Ready to segment like a pro?** 🚀

[Resolve doubts about Nevent Temperature, groups, deliverability and more →](/en/segmentation/segmentation-engine/faq/)
