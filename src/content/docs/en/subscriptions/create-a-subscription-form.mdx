...
- [Import Existing Contacts](/en/audience/import-fans) if you have a list of fans from past editions you want to add to Nevent without going through the form.
- [A Fan's Profile](/en/audience/fan-management) to understand what data Nevent stores about each person in your database.
