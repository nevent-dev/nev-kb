...
<Schema>{`{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://docs.nevent.com/segmentacion/tu-primer-segmento"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Preguntas Frecuentes",
      "item": "https://docs.nevent.com/segmentacion/preguntas-frecuentes"
    }
  ]
}`}</Schema>
...
**Solución:**
- Revisa la [referencia completa de categorías](/segmentacion/capacidades)
...
- 📖 [Volver a Introducción](/segmentacion/tu-primer-segmento/)
- 📚 [Ver Casos de Uso](/segmentacion/casos/)
- 💬 Contacta a soporte: soporte@nevent.com
...
[Vuelve al Motor de Segmentación: guía completa con 6 categorías y RFM →](/segmentacion/tu-primer-segmento/)
