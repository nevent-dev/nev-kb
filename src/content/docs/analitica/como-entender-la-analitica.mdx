...
sidebar:
  label: "Cómo entender la analítica"
  order: 9
---
...
- El open rate mide qué porcentaje de destinatarios abrió el mensaje. Evalúa si el asunto y el remitente generan curiosidad.
- El click rate mide qué porcentaje hizo clic en algún enlace. Evalúa si el contenido genera suficiente interés como para actuar.
- El conversion rate mide qué porcentaje completó la compra. Evalúa si la página de destino y el precio convierten.
