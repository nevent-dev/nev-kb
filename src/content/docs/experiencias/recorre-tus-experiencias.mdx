...
sidebar:
  label: "Recorre tus experiencias"
  order: 1
faqs:
...
- [Cómo leer los analytics de tu evento](/experiencias/analytics)
- [Cómo definir el perfil musical de tu evento](/experiencias/perfil-musical)
