...
- Contacta a soporte: support@nevent.es
...
### Caso real: Festival de electrónica

**Segmento:** Fans de electrónica para festival 2026

**Criterios:**
```
Género preferido: Electrónica, EDM, Techno, House, Trance
AND Ciudad: Ciudad del evento, ≤100km (locales + cercanías)
...
### Caso de estudio: Festival de 150k asistentes 2024
...
### Caso real: Festival de 60k asistentes
